...
export function Hero() {
  return (
    <section id="inicio" className="noise relative min-h-[92svh] overflow-hidden bg-[#171714] text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-[92svh] max-w-7xl items-end px-4 pb-14 pt-28 sm:px-8 sm:pb-24 lg:items-center lg:pb-0">
        <div className="max-w-2xl">
          <p className="eyebrow fade-up mb-5 text-[#dec692]">Elegância em cada detalhe</p>
          <h1 className="display fade-up text-[clamp(3.1rem,17vw,8.5rem)] font-medium leading-[.8] tracking-[-.035em] sm:text-[clamp(3.6rem,9vw,8.5rem)] sm:leading-[.76]">Essencial.<br/><span className="italic font-normal">Inconfundível.</span></h1>
          ...
          <a href="#catalogo" className="fade-up-delay mt-9 inline-flex min-h-11 items-center gap-5 border-b border-[#c8a45d] pb-2 text-xs font-bold uppercase tracking-[.18em] transition-all hover:gap-7 hover:text-[#dec692]">Ver catálogo <ArrowIcon className="h-5 w-5" /></a>
        </div>
      </div>
