...
export const products: Product[] = [
  ...
  { id: "shoulder-bag-piauiense-serra-da-capivara-1", name: "Shoulder Bag com Estampas Piauienses - Serra da Capivara 01", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-serra-da-capivara-1", 3) },
  { id: "shoulder-bag-piauiense-caju-1", name: "Shoulder Bag com Estampas Piauienses - Caju 01", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-caju-1", 2) },
  { id: "shoulder-bag-piauiense-caju-2", name: "Shoulder Bag com Estampas Piauienses - Caju 02", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-caju-2", 3) },
  { id: "shoulder-bag-piauiense-serra-da-capivara-2", name: "Shoulder Bag com Estampas Piauienses - Serra da Capivara 02", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-serra-da-capivara-2", 3) },
  { id: "shoulder-bag-piauiense-caju-3", name: "Shoulder Bag com Estampas Piauienses - Caju 03", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-caju-3", 4) },
  { id: "shoulder-bag-piauiense-guara", name: "Shoulder Bag com Estampas Piauienses - Guará", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-guara", 4) },
];
