...
export const products: Product[] = [
  ...
  { id: "shoulder-bag-piauiense-caju-4", name: "Shoulder Bag com Estampas Piauienses - Caju", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-caju-4", 4) },
  { id: "shoulder-bag-piauiense-caju-5", name: "Shoulder Bag com Estampas Piauienses - Caju", category: "Bolsas", subcategory: "Shoulder Bag", description: "Tamanho: C- 15cm, A- 19,5cm e L- 5,5cm.", images: imageList("shoulder-bag-piauiense-caju-5", 4) },
